      ...
      <div style={{ position: "sticky", top: 0, zIndex: 50, background: "rgba(15,20,32,0.93)", backdropFilter: "blur(20px)", WebkitBackdropFilter: "blur(20px)", borderBottom: "1px solid rgba(123,97,255,0.1)", padding: "11px 16px", display: "flex", alignItems: "center", gap: "10px" }}>
        ...
        <div style={{ flex: 1 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "5px" }}>
            ...
            <p style={{ fontSize: "12px", color: "rgba(255,255,255,0.3)", fontFamily: "'DM Sans',sans-serif" }}>{lang === "en" ? "online" : "en linea"}</p>
          </div>
        </div>
        <span style={{ fontSize: "12px", color: used >= 10 ? "#F87171" : "rgba(255,255,255,0.2)", fontFamily: "'DM Sans',sans-serif", fontWeight: 600 }}>{used}/10 {lang === "en" ? "today" : "hoy"}</span>
      </div>
