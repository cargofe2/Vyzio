...
export default function ProfilePage() {
  ...
  const LEVELS = [
    { id: "level-1", label: "Nivel 0 â€” Origins" },
    { id: "level-new-1", label: "Nivel 1 â€” Explorer" },
    { id: "level-new-2", label: "Nivel 2 â€” Thinker" },
    { id: "level-new-3", label: "Nivel 3 â€” Creator" },
    { id: "level-new-4", label: "Nivel 4 â€” Builder" },
    { id: "level-new-5", label: "Nivel 5 â€” Architect" },
    { id: "level-new-6", label: "Nivel 6 â€” Founder" },
    { id: "level-new-7", label: "Nivel 7 â€” Researcher" },
    { id: "level-new-8", label: "Nivel 8 â€” Residency" },
  ];
    ...
    <div style={{ minHeight: "100vh", background: "#0F1420", paddingBottom: "88px" }}>
      ...
      <div style={{ background: "rgba(15,20,32,0.93)", backdropFilter: "blur(20px)", WebkitBackdropFilter: "blur(20px)", borderBottom: "1px solid rgba(123,97,255,0.1)", padding: "16px" }}>
        <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "14px" }}>
          ...
          <div style={{ flex: 1 }}>
            ...
            <span style={{ fontSize: "9px", padding: "2px 8px", borderRadius: "8px", fontWeight: 700, background: `${rankCfg.color}18`, color: rankCfg.color, border: `1px solid ${rankCfg.color}33`, fontFamily: "'DM Sans',sans-serif" }}>{rankCfg.label} Â· Lv.{gamification?.rankLevel ?? 1}</span>
          </div>
          <button
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", background: "rgba(123,97,255,0.06)", border: "1px solid rgba(123,97,255,0.1)", borderRadius: "14px", overflow: "hidden" }}>
          {[[String(gamification?.lessonsCompleted ?? 0), "Lecciones"], [xp.toLocaleString(), "XP Total"], [`ðŸ”¥ ${gamification?.streakDays ?? 0}`, "Racha"]].map(([v, l], i) => (
      ...
      <div style={{ padding: "14px 16px", display: "flex", flexDirection: "column", gap: "10px" }}>
        ...
        <Link href={`/worlds?levelId=${currentLevel?.id ?? "level-1"}`} style={{ textDecoration: "none" }}>
          <div style={{ background: "rgba(123,97,255,0.07)", border: "1px solid rgba(123,97,255,0.15)", borderRadius: "16px", padding: "14px", display: "flex", alignItems: "center", gap: "12px" }}>
            ...
            <div>
              ...
              <p style={{ fontSize: "11px", color: "rgba(255,255,255,0.35)", fontFamily: "'DM Sans',sans-serif" }}>Donde vas ahora â€” toca para continuar</p>
            </div>
          </div>
        </Link>
        ...
        <div style={{ background: "rgba(123,97,255,0.08)", border: "1px solid rgba(123,97,255,0.2)", borderRadius: "16px", padding: "14px", display: "flex", alignItems: "center", gap: "12px" }}>
          <div style={{ width: "40px", height: "40px", background: "rgba(123,97,255,0.12)", border: "1px solid rgba(123,97,255,0.2)", borderRadius: "12px", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "20px" }}>ðŸŽ“</div>
          <div style={{ flex: 1 }}>
          ...
          <Link href="/worlds" style={{ padding: "6px 12px", background: "#7B61FF", color: "#fff", borderRadius: "10px", fontSize: "11px", fontWeight: 700, textDecoration: "none", fontFamily: "'DM Sans',sans-serif" }}>Ir â†’</Link>
        </div>
        ...
        <section>
          ...
          {loading ? (
            ...
            <div style={{ background: "rgba(123,97,255,0.05)", border: "1px solid rgba(123,97,255,0.1)", borderRadius: "16px", padding: "24px", textAlign: "center" }}>
              ...
              <p style={{ fontSize: "12px", fontWeight: 600, color: "#fff", marginBottom: "4px", fontFamily: "'DM Sans',sans-serif" }}>Sin logros aÃºn</p>
        ...
        <section>
          <div style={{ display: "flex", gap: "8px", padding: "0 4px" }}>
            <Link href="/terms" style={{ fontSize: "11px", color: "#7E8798", textDecoration: "none", fontFamily: "'DM Sans',sans-serif" }}>TÃ©rminos de Servicio</Link>
            <span style={{ color: "#324055" }}>Â·</span>
