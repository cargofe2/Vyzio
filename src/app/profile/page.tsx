  ...
  return (
    <div style={{ minHeight: "100vh", background: "#0F1420", paddingBottom: "88px" }}>
      ...
      <div style={{ padding: "16px", display: "flex", flexDirection: "column", gap: "20px" }}>
        ...
        {/* LOGROS */}
        <section>
          <h2 style={{ fontSize: "10px", fontWeight: 700, textTransform: "uppercase", letterSpacing: "1px", color: "rgba(255,255,255,0.25)", marginBottom: "12px" }}>{t("achievements")}</h2>
          {achievements.length > 0 ? (
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "8px" }}>
              {achievements.map((a, i) => (
                <div key={i} style={{ background: "rgba(123,97,255,0.05)", border: "1px solid rgba(123,97,255,0.1)", borderRadius: "14px", padding: "12px" }}>
                  ...
                  <p style={{ fontWeight: 700, fontSize: "11px", color: "#fff", marginBottom: "2px" }}>{a.achievement.name}</p>
                  <p style={{ fontSize: "9px", color: "rgba(255,255,255,0.3)" }}>{a.achievement.description}</p>
                </div>
              ))}
            </div>
          ) : (
            <div style={{ background: "rgba(123,97,255,0.05)", border: "1px solid rgba(123,97,255,0.1)", borderRadius: "16px", padding: "24px", textAlign: "center" }}>
              ...
              <p style={{ fontSize: "13px", fontWeight: 600, color: "#fff", marginBottom: "4px" }}>{t("noAchiev")}</p>
              <p style={{ fontSize: "11px", color: "rgba(255,255,255,0.3)" }}>{t("noAchievSub")}</p>
              <Link href="/worlds" style={{ display: "inline-block", marginTop: "12px", padding: "8px 16px", background: "rgba(123,97,255,0.15)", border: "1px solid rgba(123,97,255,0.3)", borderRadius: "10px", color: "#A78BFA", fontSize: "12px", fontWeight: 700, textDecoration: "none" }}>
