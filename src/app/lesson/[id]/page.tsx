...
const TYPE_CONFIG: Record<string, { label: string; color: string }> = {
  ...
  { n: 8, name: "Residency", color: "#F472B6", desc: "Aplicas todo lo aprendido en un proyecto real, con un problema real y consecuencias reales. El resultado depende directamente de lo que pongas. Termina con el Grand Challenge." },
