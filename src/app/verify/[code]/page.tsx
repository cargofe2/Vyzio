        ...
        {cert ? (
          <>
            ...
            <div style={{ background: "rgba(123,97,255,0.08)", border: "1px solid rgba(123,97,255,0.25)", borderRadius: "14px", padding: "16px", marginBottom: "20px" }}>
              ...
              <p style={{ fontSize: "11px", color: "#7E8798", marginTop: "4px", fontFamily: "'DM Sans',sans-serif" }}>en Bymyzai</p>
            </div>
            ...
            <p style={{ fontSize: "9px", color: "#4A5568", marginTop: "16px", fontFamily: "'DM Sans',sans-serif", lineHeight: 1.5 }}>
              Este certificado reconoce la finalización de un programa de estudio en Bymyzai, una plataforma educativa privada. No constituye un título, grado o acreditación académica formal, ni implica reconocimiento por instituciones educativas o gubernamentales.
            </p>
          ...
          <>
            ...
            <p style={{ fontSize: "13px", color: "#B3BDD1", fontFamily: "'DM Sans',sans-serif" }}>Este código de verificación no corresponde a ningún certificado emitido por Bymyzai.</p>
          </>
        )}
      </div>
    </main>
