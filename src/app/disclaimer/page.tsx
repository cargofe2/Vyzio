...
export default function DisclaimerPage() {
  ...
  const es = (
    <>
      ...
      <p style={s.date}>Última actualización: julio 2025</p>
      <p style={s.p}>Lee este aviso detenidamente antes de usar Bymyzai.</p>

      <h2 style={s.h2}>1. Contenido Educativo</h2>
      <p style={s.p}>Bymyzai proporciona educación en inteligencia artificial con fines informativos y de desarrollo únicamente. Todo el contenido — incluyendo lecciones, proyectos, evaluaciones e interacciones con ZAI — no constituye asesoramiento profesional, académico, legal, financiero ni laboral.</p>
      <p style={s.p}>Completar cualquier nivel, certificado o programa de Bymyzai no garantiza empleo, admisión a ninguna institución ni certificación profesional. Los resultados dependen del esfuerzo y circunstancias individuales de cada estudiante.</p>
      <div style={s.callout}><strong style={{ color: "#F2C04D" }}>Nota:</strong> Los certificados de Bymyzai representan hitos de aprendizaje dentro de la plataforma. No son credenciales académicas acreditadas bajo la ley estadounidense ni internacional.</div>
      ...
      <ul style={s.ul}>
        <li style={s.li}>Las respuestas generadas por IA pueden contener errores o información desactualizada.</li>
        ...
        <li style={s.li}>Tus interacciones pueden ser procesadas por proveedores de IA de terceros sujetos a sus propias políticas.</li>
        <li style={s.li}>Bymyzai no utiliza tus datos para entrenar modelos de IA externos sin consentimiento explícito.</li>
      </ul>

      <h2 style={s.h2}>3. Usuarios Menores de 18 Años</h2>
      <p style={s.p}>Bymyzai atiende a estudiantes de 13 años en adelante. Los usuarios de 13 a 17 años deben contar con el consentimiento verificable de sus padres o tutores antes de crear una cuenta.</p>
      <ul style={s.ul}>
        <li style={s.li}>Los usuarios menores de 13 años tienen prohibido el uso de la plataforma (cumplimiento COPPA).</li>
        <li style={s.li}>Los padres pueden solicitar acceso, corrección o eliminación de los datos de su hijo en <a href="mailto:privacy@bymyzai.com" style={s.a}>privacy@bymyzai.com</a>.</li>
        <li style={s.li}>El consentimiento parental para usuarios de 16 a 17 años se obtiene por confirmación por correo previo a la activación de la cuenta.</li>
      </ul>
      <div style={s.callout}><strong style={{ color: "#F2C04D" }}>Padres:</strong> Si su hijo menor de 13 años se ha registrado en Bymyzai, contáctenos en <a href="mailto:privacy@bymyzai.com" style={s.a}>privacy@bymyzai.com</a> y eliminaremos la cuenta en 5 días hábiles.</div>

      <h2 style={s.h2}>4. Usuarios Internacionales y RGPD</h2>
      <p style={s.p}>Bymyzai es operado por Carlos Eduardo Gonzalez Fernandez, individuo con domicilio en Nueva Jersey, Estados Unidos, regido por las leyes del Estado de Nueva Jersey y la legislación federal aplicable.</p>
      <p style={s.p}>Si te encuentras en el EEE, el Reino Unido o Suiza, cuentas con derechos adicionales bajo el RGPD: acceso, rectificación, supresión, limitación, portabilidad y retirada del consentimiento en cualquier momento.</p>
      ...
      <div style={s.callout}><strong style={{ color: "#F2C04D" }}>Base jurídica (Art. 6 RGPD):</strong> Ejecución de contrato, interés legítimo en la operación de la plataforma y consentimiento explícito donde sea requerido.</div>

      <h2 style={s.h2}>5. Contacto</h2>
      <p style={{ ...s.p, marginBottom: "40px" }}>Para consultas sobre este aviso o tus derechos: <a href="mailto:privacy@bymyzai.com" style={s.a}>privacy@bymyzai.com</a>. Respondemos en 30 días. Los usuarios del EEE pueden también presentar una reclamación ante su autoridad de control local.</p>
    </>
  );
