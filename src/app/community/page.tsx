...
const T = {
  title:    { es: "Liga Bymyzai",                           en: "Bymyzai League" },
  subtitle: { es: "Ranking · Proyectos · Equipos",          en: "Ranking · Projects · Teams" },
  soon:     { es: "Próximamente",                           en: "Coming Soon" },
  desc:     { es: "La comunidad se activa cuando publiques tu primer proyecto. Completa lecciones para desbloquearla.", en: "The community activates when you publish your first project. Complete lessons to unlock it." },
  cta:      { es: "Ir a aprender →",                       en: "Start learning →" },
...
export default function CommunityPage() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#0F1420", paddingBottom: "88px" }}>
      ...
      {/* Header */}
      <div style={{ background: "rgba(15,20,32,0.93)", backdropFilter: "blur(20px)", WebkitBackdropFilter: "blur(20px)", borderBottom: "1px solid rgba(123,97,255,0.1)", padding: "14px 16px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        <div>
          <h1 style={{ fontFamily: "'Syne',sans-serif", fontWeight: 900, color: "#F8FAFF", fontSize: "18px", marginBottom: "2px" }}>{t("title")} 🏆</h1>
          <p style={{ fontSize: "11px", color: "rgba(255,255,255,0.3)", fontFamily: "'DM Sans',sans-serif" }}>{t("subtitle")}</p>
        </div>
        <LangToggle />
      </div>
      ...
      <div style={{ padding: "48px 24px", textAlign: "center" }}>
        <div style={{ width: "72px", height: "72px", background: "rgba(251,191,36,0.1)", border: "1px solid rgba(251,191,36,0.2)", borderRadius: "20px", display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 16px" }}>
          <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#F2C04D" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M7 4.5h10v4.5a5 5 0 0 1-10 0V4.5Z"/><path d="M7 6H4.8A1.3 1.3 0 0 0 3.5 7.3v.4a3.2 3.2 0 0 0 3.2 3.2H7M17 6h2.2a1.3 1.3 0 0 1 1.3 1.3v.4a3.2 3.2 0 0 1-3.2 3.2H17"/><path d="M12 13.5v3M9.2 19.5h5.6c-.1-1.5-.5-2.3-1-2.7h-3.6c-.5.4-.9 1.2-1 2.7Z"/></svg>
        </div>
        <h2 style={{ fontFamily: "'Syne',sans-serif", fontWeight: 800, color: "#fff", fontSize: "18px", marginBottom: "8px" }}>{t("soon")}</h2>
        ...
        <Link href="/worlds" style={{ display: "inline-block", padding: "12px 24px", background: "linear-gradient(135deg,#7B61FF,#8B5CF6)", color: "#fff", borderRadius: "14px", fontWeight: 700, fontSize: "13px", textDecoration: "none", fontFamily: "'DM Sans',sans-serif" }}>
          {t("cta")}
        </Link>
      </div>
